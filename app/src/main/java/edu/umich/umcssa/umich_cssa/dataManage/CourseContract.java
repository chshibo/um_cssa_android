...
public final class CourseContract {
    ...
    public static class Course implements BaseColumns{
        ...
        public static final String COLUMN_COURSE_SECTION="section";
    ...
    public static final String CREATE_TABLE="CREATE TABLE "+Course.TABLE_NAME+"("+
            ...
            Course.COLUMN_COURSE_NAME+" TEXT,"+Course.COLUMN_COURSE_SECTION+" INTEGER,"+
            Course.COLUMN_START_TIME+" INTEGER,"+ Course.COLUMN_END_TIME+" INTEGER,"+
            Course.COLUMN_LOC+" TEXT)";
